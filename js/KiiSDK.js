...
root.KiiGroup = (function() {
  ...
  KiiGroup.prototype.topicWithName = function(topicName) {
    ...
    id = this.getID();
    if (!id) {
      throw 'can not instantiate topic from instance which don\'t have ID';
    }
    puri = "" + (root.Kii.getBaseURL()) + "/apps/" + (root.Kii.getAppID()) + "/groups/" + id;
    return new root.KiiTopic(puri, topicName);
  };
...
root.KiiUser = (function() {
  ...
  KiiUser.prototype.topicWithName = function(topicName) {
    ...
    puri = "" + (root.Kii.getBaseURL()) + "/apps/" + (root.Kii.getAppID()) + "/users/" + id;
    return new root.KiiTopic(puri, topicName);
  };
...
root.KiiThing = (function() {
  ...
  KiiThing.prototype.refresh = function(callbacks) {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        return _this._refresh().then(function(respJson) {
  ...
  KiiThing.prototype._refresh = function() {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        var qualifiedID, sendCallbacks, wrapper;
        if (_this._thingID != null) {
          qualifiedID = _this._thingID;
        } else {
          qualifiedID = "VENDOR_THING_ID:" + _this._vendorThingID;
        }
        ...
        sendCallbacks = {
          ...
          failure: function() {
            ...
            return reject(KiiUtilities._Error(errString, _this));
          }
        };
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        return _this._refresh().then(function(respJson) {
          ...
          if (typeof _this._testOnUpdateRequest === "function") {
            _this._testOnUpdateRequest();
          }
...
if (b && module.exports) {
  module.exports = {
    exportedClasses: ['KiiUser', 'KiiServerCodeExecResult', 'KiiAnyAuthenticatedUser', 'KiiEncryptedBucket', 'KiiAppAdminContext', 'KiiQuery', 'KiiTopicAdmin', 'KiiSDKClientInfo', 'KiiACL', 'KiiSocialConnectNetwork', 'KiiBucket', 'KiiServerCodeEntry', 'KiiThingAdmin', 'KiiThing', 'KiiPushSubscriptionAdmin', 'KiiObjectAdmin', 'KiiSCNTwitter', 'KiiPushSubscription', 'KiiObject', 'Kii', 'KiiAnonymousUser', 'KiiSocialConnect', 'KiiGroup', 'KiiSCNQQ', 'ForTest', 'KiiACLAdmin', 'KiiGeoPoint', 'KiiGroupAdmin', 'KiiBucketAdmin', 'KiiUserAdmin', 'KiiEncryptedBucketAdmin', 'KiiTopic', 'KiiPushMessageBuilder', 'KiiClause', 'KiiACLEntry', 'KiiSCNFacebook', 'KiiSocialNetworkName', 'KiiSite', '_KiiHttpRequestType', 'InvalidDisplayNameException', 'InvalidPasswordException', 'InvalidUsernameException', 'InvalidUserIdentifierException', 'InvalidEmailException', 'InvalidPhoneNumberException', 'InvalidLocalPhoneNumberException', 'InvalidCountryException', 'InvalidURIException', 'InvalidACLAction', 'InvalidACLSubject', 'InvalidACLGrant', 'InvalidLimitException', 'InvalidArgumentException', 'IllegalStateException', 'ArithmeticException', 'KiiACLAction'],
    create: function() {
